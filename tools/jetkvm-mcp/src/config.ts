...
export const MCP_TRANSPORT_MAX_REQUEST_BYTES = 2_097_152;
export const LEGACY_SSE_ACTIVE_REQUEST_BODY_BUDGET_BYTES = 67_108_864;
export const LEGACY_SSE_ACTIVE_REQUEST_BODY_BYTES_PER_PRINCIPAL = 16_777_216;
export const LEGACY_SSE_ACTIVE_REQUEST_BODY_BYTES_PER_SESSION = 4_194_304;
export const LEGACY_SSE_MIN_RESPONSE_MESSAGE_BYTES = 14_680_064;

export const LEGACY_SSE_QUEUED_RESPONSE_BUDGET_BYTES = 67_108_864;
export const LEGACY_SSE_QUEUED_RESPONSE_BYTES_PER_PRINCIPAL = 16_777_216;
export const LEGACY_SSE_QUEUED_RESPONSE_BYTES_PER_STREAM = 16_777_216;
export const LEGACY_SSE_MAX_HEADER_BYTES = 16_384;
...
const DEFAULT_SSE_MAX_RESPONSE_MESSAGE_BYTES =
...
export function parseLegacySsePolicy(
  ...
  if (maxResponseMessageBytes < LEGACY_SSE_MIN_RESPONSE_MESSAGE_BYTES) {
    throw new OperatorConfigError(
      `Legacy SSE maximum serialized response message must be at least ${LEGACY_SSE_MIN_RESPONSE_MESSAGE_BYTES}`,
    );
  }
